return {
	{
		...
		config = function()
			...
			vim.keymap.set("n", "<leader>ss", builtin.builtin, { desc = "[S]earch [S]elect felescope" })
			...
			vim.keymap.set("n", "<leader>gr", builtin.lsp_references, { desc = "[G]oto [R]Reference" })
			...
			-- local project_actions = require("telescope-project.project_actions" )
